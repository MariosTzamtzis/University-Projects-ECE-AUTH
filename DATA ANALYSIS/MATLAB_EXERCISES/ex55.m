...
fprintf("Parametric confidence interval for intercept: " + ...
    "[%.3f, %.3f]\n",bint(1,1),bint(1,2));
fprintf("Bootstrap confidence interval for intercept: " + ...
    "[%.3f, %.3f]\n",bci(1,1),bci(1,2));
fprintf("Parametric confidence interval for slope: " + ...
    "[%.3f, %.3f]\n",bint(2,1),bint(2,2));
fprintf("Bootstrap confidence interval for slope: " + ...
    "[%.3f, %.3f]\n",bci(2,1),bci(2,2));